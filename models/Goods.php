 ...
 * Goods
 *
 * @ORM\Table(name="goods", indexes={@ORM\Index(name="FK_goods_goods_status", columns={"goods_status"}), @ORM\Index(name="goods_nds_type", columns={"goods_nds_type"}), @ORM\Index(name="order_id", columns={"order_id"})})
 * @ORM\Entity
 */
class Goods
{
