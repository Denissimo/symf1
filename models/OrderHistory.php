 ...
 * OrderHistory
 *
 * @ORM\Table(name="order_history", indexes={@ORM\Index(name="user_id", columns={"user_id"}), @ORM\Index(name="IDX_logs_orders_what", columns={"what"}), @ORM\Index(name="old_id_logs", columns={"description"})})
 * @ORM\Entity
 */
class OrderHistory
{
